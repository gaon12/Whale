...
대표 스타일: `initial-face`, `initials`, `identicon`, `bottts`, `bottts-neutral`, `pixel-art`, `pixel-art-neutral`, `adventurer`, `avataaars`, `lorelei`, `notionists`, `open-peeps`, `personas`.
...
| `$wgWhaleMainColor` | 사이트 전체 주 색상 | `'#7568E8'` | `'#7568E8'` |
| `$wgWhaleSecondColor` | 사이트 전체 보조 색상 | `'#5F57CF'` | `null` |
...
Representative styles: `initial-face`, `initials`, `identicon`, `bottts`, `bottts-neutral`, `pixel-art`, `pixel-art-neutral`, `adventurer`, `avataaars`, `lorelei`, `notionists`, `open-peeps`, `personas`.
...
| `$wgWhaleMainColor` | Site-wide primary color | `'#7568E8'` | `'#7568E8'` |
| `$wgWhaleSecondColor` | Site-wide secondary color | `'#5F57CF'` | `null` |
